...
const TopGame = () => {
    return (
        <div className="card w-auto text-black shadow-2xl  mb-3 border-4  bg-gradient-to-r from-slate-400/40   to-sky-300/70  lg:rounded-b-3xl border-b-2 border-sky-800">
