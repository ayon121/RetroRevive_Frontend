...
const Footer = () => {
    return (
        <footer className="footer p-10  bg-gradient-to-r from-pink-700/40  via-purple-950 to-sky-950/70  lg:rounded-b-3xl border-sky-300 text-white border-t-4 border-double  md:rounded-tr-full">
