        ...
        <div className="hero min-h-screen h-auto w-full banner mb-4" style={{ backgroundImage: `url(${bannerimage})`  }}>
            ...
            <div className=" text-left text-neutral-content mt-11 lg:mt-10  pt-8 lg:pt-7  pb-5 lg:pb-2">
                <div className="max-w-7xl px-4 ">
                    ...
                    <button className="group relative flex gap-1 w-32 md:w-36 items-center rounded-lg border-2 border-[#FF5733] p-4 text-sky-300 "><span className="text-sm ">JOIN NOW </span><span className="absolute right-3 box-content flex w-1/6 justify-center rounded-md bg-[#FF5733] duration-300 group-hover:w-5/6 "><svg viewBox="0 0 24 24" fill="none" className="w-10" xmlns="http://www.w3.org/2000/svg"><g strokeWidth="0"></g><g strokeLinecap="round" strokeLinejoin="round"></g><g><path d="M4 12H20M20 12L14 6M20 12L14 18" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></g></svg></span></button>
