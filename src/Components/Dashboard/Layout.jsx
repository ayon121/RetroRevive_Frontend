    ...
    return (
        <div className="backgrnd">
            <div className="flex gap-4 ">
                <div className="lg:w-64 md:w-44 px-3 border-r-2 border-sky-300 flex flex-col pt-5 justify-center bg-gradient-to-r from-pink-800/40  via-purple-950 to-sky-950/80">
                    ...
                    <Link><button className="btn w-full   my-3 bg-gradient-to-r from-sky-700/40  via-purple-500/40 to-pink-400/80 font-bold hover:border-sky-300">Add Game</button></Link>
